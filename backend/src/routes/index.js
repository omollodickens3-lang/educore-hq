...
router.get('/exams/stream-ranking', authenticate, requireStreamAccess, exams.getStreamRanking);
...
router.get('/exams/broadsheet', authenticate, requireStreamAccess, exams.getBroadsheet);
